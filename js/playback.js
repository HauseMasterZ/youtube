        ...
        if (!thumbsDisabled && getThumbUrl(track)) {
            ...
            const onPlayStart = () => {
                ...
                if (currentPlaybackSequence === sequenceId) {
                    ...
                    if (window.hasMediaSession && navigator.mediaSession.metadata) {
