...
class TestMediaSessionEngine(unittest.TestCase):
    ...
    def test_mode2_lockscreen_resume_with_500ms_lockout(self):
        """Pause action handler resumes in Mode 2 after 500ms lockout and pauses during disconnect"""
        ...
        self.assertIn("timeSincePause >= 500", pause_code)
